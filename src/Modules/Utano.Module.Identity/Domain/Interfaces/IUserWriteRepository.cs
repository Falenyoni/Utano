...
public interface IUserWriteRepository
{
    ...
    Task AddEmailVerificationTokenAsync(Guid userId, string tokenHash, int expiryMinutes, CancellationToken cancellationToken = default);
    Task MarkEmailVerificationTokenUsedAsync(Guid tokenId, CancellationToken cancellationToken = default);
}
