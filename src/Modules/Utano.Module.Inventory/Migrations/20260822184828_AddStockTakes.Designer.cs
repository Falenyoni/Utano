...
namespace Utano.Module.Inventory.Migrations
{
    ...
    [Migration("20260822184828_AddStockTakes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Utano.Module.Inventory.Domain.Entities.StockTake", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PracticeId", "StartedAt");

                    b.ToTable("StockTakes", (string)null);
                });

            modelBuilder.Entity("Utano.Module.Inventory.Domain.Entities.StockTakeLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Utano.Module.Inventory.Domain.Entities.StockTakeLine", b =>
                {
                    b.HasOne("Utano.Module.Inventory.Domain.Entities.StockTake", null)
                        .WithMany("Lines")
